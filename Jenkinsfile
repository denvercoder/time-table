node('iOS Node') {
    ...
    stage('Checkout/Build/Test') {
        ...
        checkout([
            ...
            userRemoteConfigs: [[
                name: 'github',
                url: 'https://github.com/denvercoder/time-table.git'
            ]]
        ])
    ...
    stage ('Notify') {
        ...
        slackSend channel: '#builds', message: 'Successful Build', teamDomain: 'DenverCoders', token: 'li6jO5f9bUTuqzAKWUzqUjJJ'
    }
}
